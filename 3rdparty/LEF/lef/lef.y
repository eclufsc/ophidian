...
manufacturing: K_MANUFACTURINGGRID dnumber ';'
    {
...
units_rule: K_TIME K_NANOSECONDS dnumber ';'
  ...
  | K_FREQUENCY K_MEGAHERTZ dnumber ';'
...
layer_option:
  ...
  | K_SPACINGTABLE K_ORTHOGONAL K_WITHIN dnumber K_SPACING dnumber   // 5.7 
    {
      if (lefCallbacks->LayerCbk)
  ...
  | K_CAPACITANCE K_CPERSQDIST dnumber ';'
    {
      if (!lefData->layerRout) {
         if (lefCallbacks->LayerCbk) { // write error only if cbk is set 
            if (lefData->layerWarnings++ < lefSettings->LayerWarnings) {
  ...
  | K_PROPERTY { lefData->lefDumbMode = 10000000; lefData->lefInProp = 1; } layer_prop_list ';'
    {
  ...
  | K_ACCURRENTDENSITY layer_table_type dnumber ';'
    {
      if (lefData->layerMastOver) {
         if (lefCallbacks->LayerCbk) { // write error only if cbk is set 
            if (lefData->layerWarnings++ < lefSettings->LayerWarnings) {
  ...
  | K_DCCURRENTDENSITY K_AVERAGE dnumber ';'
    {
      if (lefData->layerMastOver) {
         if (lefCallbacks->LayerCbk) { // write error only if cbk is set 
            if (lefData->layerWarnings++ < lefSettings->LayerWarnings) {
  ...
  | K_DCCURRENTDENSITY K_AVERAGE K_CUTAREA dnumber
    {
      if (lefData->layerMastOver) {
         if (lefCallbacks->LayerCbk) { // write error only if cbk is set 
            if (lefData->layerWarnings++ < lefSettings->LayerWarnings) {
    ...
    dc_layer_table {}
  | K_DCCURRENTDENSITY K_AVERAGE K_WIDTH dnumber
    {
      if (lefData->layerMastOver) {
         if (lefCallbacks->LayerCbk) { // write error only if cbk is set 
            if (lefData->layerWarnings++ < lefSettings->LayerWarnings) {
...
// 3/23/2000 - 5.4 syntax.  Wanda da Rosa 
  ...
  | K_ANTENNAAREAFACTOR dnumber
    ...
    layer_antenna_duo ';' {}
  | K_ANTENNASIDEAREARATIO dnumber ';'
    { // 5.4 syntax 
      lefData->use5_4 = 1;
      if (!lefData->layerRout && (lefData->layerCut || lefData->layerMastOver)) {
         if (lefCallbacks->LayerCbk) { // write error only if cbk is set 
  ...
  | K_ANTENNADIFFSIDEAREARATIO
    ...
    layer_antenna_pwl ';' {}
  | K_ANTENNACUMSIDEAREARATIO dnumber ';'
    { // 5.4 syntax 
      lefData->use5_4 = 1;
      if (!lefData->layerRout && (lefData->layerCut || lefData->layerMastOver)) {
         if (lefCallbacks->LayerCbk) { // write error only if cbk is set 
  ...
  | K_ANTENNACUMDIFFSIDEAREARATIO
    ...
    layer_antenna_pwl ';' {}
  | K_ANTENNASIDEAREAFACTOR dnumber
    { // 5.4 syntax 
      lefData->use5_4 = 1;
      if (!lefData->layerRout && (lefData->layerCut || lefData->layerMastOver)) {
         if (lefCallbacks->LayerCbk) { // write error only if cbk is set 
  ...
  | K_ANTENNAGATEPLUSDIFF dnumber ';'      // 5.7 
    {
      if (lefData->versionNum < 5.7) {
         lefData->outMsg = (char*)lefMalloc(10000);
         sprintf(lefData->outMsg,
  ...
  | K_ANTENNAAREAMINUSDIFF dnumber ';'     // 5.7 
    {
      if (lefData->versionNum < 5.7) {
         lefData->outMsg = (char*)lefMalloc(10000);
         sprintf(lefData->outMsg,
  ...
  | K_MAXADJACENTSLOTSPACING dnumber ';'
    { // 5.4 syntax 
      if (lefData->ignoreVersion) {
         // do nothing 
  ...
  | K_MAXCOAXIALSLOTSPACING dnumber ';'
    { // 5.4 syntax 
      if (lefData->ignoreVersion) {
         // do nothing 
  ...
  | K_DENSITYCHECKWINDOW dnumber dnumber ';'
    { // 5.4 syntax, pcr 394389 
      if (lefData->ignoreVersion) {
         // do nothing 
      } else if (lefData->versionNum < 5.4) {
  ...
  | K_MINENCLOSEDAREA dnumber           // 5.5 
    ...
    layer_minen_width ';' {}
  | K_MINIMUMCUT dnumber K_WIDTH dnumber // 5.5 
    { // pcr 409334 
      if (lefCallbacks->LayerCbk)
  ...
  | K_PROTRUSIONWIDTH dnumber K_LENGTH dnumber K_WIDTH dnumber ';'  // 5.5 
    {
      if (lefData->versionNum < 5.5) {
         if (lefCallbacks->LayerCbk) { // write error only if cbk is set 
            if (lefData->layerWarnings++ < lefSettings->LayerWarnings) {
  ...
  | K_ENCLOSURE layer_enclosure_type_opt dnumber dnumber
    {
      if (lefData->versionNum < 5.6) {
         if (lefCallbacks->LayerCbk) { // write error only if cbk is set 
            if (lefData->layerWarnings++ < lefSettings->LayerWarnings) {
  ...
  | K_PREFERENCLOSURE layer_enclosure_type_opt dnumber dnumber
    {
      if (lefData->versionNum < 5.6) {
         if (lefCallbacks->LayerCbk) { // write error only if cbk is set 
            if (lefData->layerWarnings++ < lefSettings->LayerWarnings) {
...
layer_arraySpacing_arraycut:
  K_ARRAYCUTS dnumber K_SPACING dnumber
    {
      if (lefCallbacks->LayerCbk)
...
sp_options:
  ...
  | K_TWOWIDTHS K_WIDTH dnumber layer_sp_TwoWidthsPRL dnumber
    {
  ...
  | K_INFLUENCE K_WIDTH dnumber K_WITHIN dnumber K_SPACING dnumber
    {
      if (lefData->hasInfluence) {  // 5.5 - INFLUENCE table must follow a PARALLEL
         if (lefCallbacks->LayerCbk) { // write error only if cbk is set 
            if (lefData->layerWarnings++ < lefSettings->LayerWarnings) {
...
layer_spacingtable_opt:
  K_WITHIN dnumber K_SPACING dnumber
  {
    if (lefCallbacks->LayerCbk)
...
layer_minimumcut_length: // empty 
  | K_LENGTH dnumber K_WITHIN dnumber
    {   
      if (lefData->versionNum < 5.5) {
         if (lefCallbacks->LayerCbk) { // write error only if cbk is set 
            if (lefData->layerWarnings++ < lefSettings->LayerWarnings) {
...
current_density_pwl: '(' dnumber dnumber ')'
...
layer_sp_parallel_width: K_WIDTH dnumber
    { 
      if (lefCallbacks->LayerCbk) {
...
layer_sp_TwoWidth: K_WIDTH dnumber layer_sp_TwoWidthsPRL dnumber
    {
...
layer_sp_influence_width: K_WIDTH dnumber K_WITHIN dnumber K_SPACING dnumber
    { if (lefCallbacks->LayerCbk) lefData->lefrLayer.addSpInfluence($2, $4, $6); }

maxstack_via: K_MAXVIASTACK dnumber ';'
    {
  ...
  | K_MAXVIASTACK dnumber K_RANGE {lefData->lefDumbMode = 2; lefData->lefNoNum= 2;}
    T_STRING T_STRING ';'
    {
      if (!lefData->lefrHasLayer) {  // 5.5 
        if (lefCallbacks->MaxStackViaCbk) { // write error only if cbk is set 
...
via_viarule: K_VIARULE {lefData->lefDumbMode = 1; lefData->lefNoNum = 1; } T_STRING ';'
  K_CUTSIZE dnumber dnumber ';'
  K_LAYERS {lefData->lefDumbMode = 3; lefData->lefNoNum = 1; } T_STRING T_STRING T_STRING ';'
  K_CUTSPACING dnumber dnumber ';'
  K_ENCLOSURE dnumber dnumber dnumber dnumber ';'
    {
       if (lefData->versionNum < 5.6) {
...
via_other_option:
  ...
  | K_PROPERTY { lefData->lefDumbMode = 1000000; lefData->lefInProp = 1; } via_prop_list ';'
    { lefData->lefDumbMode = 0;
      lefData->lefInProp = 0;
    }
  | K_TOPOFSTACKONLY
...
viarule_prop: K_PROPERTY { lefData->lefDumbMode = 10000000; lefData->lefInProp = 1; } viarule_prop_list ';'
    { lefData->lefDumbMode = 0;
      lefData->lefInProp = 0;
    }
...
viarule_layer_option:
  ...
  | K_ENCLOSURE dnumber dnumber ';'    // 5.5 
    {
      if (lefData->versionNum < 5.5) {
         if (lefCallbacks->ViaRuleCbk) { // write error only if cbk is set 
           if (lefData->viaRuleWarnings++ < lefSettings->ViaRuleWarnings) {
...
spacing:  samenet_keyword T_STRING T_STRING dnumber ';'
    {
      if ((lefData->versionNum < 5.6) || (!lefData->ndRule)) {
        if (lefData->versionNum < 5.7) {
  ...
  | samenet_keyword T_STRING T_STRING dnumber K_STACK ';'
    {
      if ((lefData->versionNum < 5.6) || (!lefData->ndRule)) {
        if (lefData->versionNum < 5.7) {
          if (lefCallbacks->SpacingCbk) {
...
ir_table_value: dnumber dnumber 
...
minfeature: K_MINFEATURE dnumber dnumber ';'
  {
...
dielectric: K_DIELECTRIC dnumber ';'
  {
    if (lefData->versionNum < 5.4) {
...
mincuts: K_MINCUTS T_STRING dnumber ';'
    {
       if (lefData->versionNum < 5.6) {
          if (lefCallbacks->NonDefaultCbk) { // write error only if cbk is set 
             if (lefData->nonDefaultWarnings++ < lefSettings->NonDefaultWarnings) {
...
nd_prop: K_PROPERTY { lefData->lefDumbMode = 10000000; lefData->lefInProp = 1; } nd_prop_list ';'
    { lefData->lefDumbMode = 0;
      lefData->lefInProp = 0;
    }
...
macro_option:
  ...
  | timing
      { }
  | K_PROPERTY {lefData->lefDumbMode = 1000000; lefData->lefInProp = 1; } macro_prop_list  ';'
      { lefData->lefDumbMode = 0;
        lefData->lefInProp = 0;
      }
...
macro_size: K_SIZE dnumber K_BY dnumber ';'
    { 
...
macro_pin_option:
  ...
  | K_OUTPUTNOISEMARGIN {lefData->lefDumbMode = 1;} dnumber dnumber ';'
    {
      if (lefData->versionNum < 5.4) {
  ...
  | K_OUTPUTRESISTANCE {lefData->lefDumbMode = 1;} dnumber dnumber ';'
    {
      if (lefData->versionNum < 5.4) {
  ...
  | K_INPUTNOISEMARGIN {lefData->lefDumbMode = 1;} dnumber dnumber ';'
    {
      if (lefData->versionNum < 5.4) {
  ...
  | K_RISEVOLTAGETHRESHOLD dnumber ';' 
    {
      if (lefData->versionNum < 5.4) {
  ...
  | K_FALLVOLTAGETHRESHOLD dnumber ';' 
    {
      if (lefData->versionNum < 5.4) {
  ...
  | K_PROPERTY {lefData->lefDumbMode = 1000000; lefData->lefInProp = 1; } pin_prop_list ';'
    { lefData->lefDumbMode = 0;
      lefData->lefInProp = 0;
    }
  ...
  | K_ANTENNASIZE dnumber opt_layer_name ';'
    {  // a pre 5.4 syntax 
      lefData->use5_3 = 1;
      if (lefData->ignoreVersion) {
        // do nothing 
  ...
  | K_ANTENNAMETALLENGTH dnumber opt_layer_name ';'
    { // a pre 5.4 syntax  
      lefData->use5_3 = 1;
      if (lefData->ignoreVersion) {
        // do nothing 
  ...
  | K_ANTENNAMAXAREACAR dnumber req_layer_name ';'
    { // 5.4 syntax 
      lefData->use5_4 = 1;
      if (lefData->ignoreVersion) {
        // do nothing 
  ...
  | K_ANTENNAMAXSIDEAREACAR dnumber req_layer_name ';'
    { // 5.4 syntax 
      lefData->use5_4 = 1;
      if (lefData->ignoreVersion) {
        // do nothing 
  ...
  | K_ANTENNAMAXCUTCAR dnumber req_layer_name ';'
    { // 5.4 syntax 
      lefData->use5_4 = 1;
      if (lefData->ignoreVersion) {
        // do nothing 
...
stepPattern: K_DO dnumber K_BY dnumber K_STEP dnumber dnumber
     { if (lefData->lefrDoGeometries)
         lefData->lefrGeometriesPtr->addStepPattern($2, $4, $6, $7); }

sitePattern: T_STRING dnumber dnumber orientation
  K_DO dnumber K_BY dnumber K_STEP dnumber dnumber
    {
  ...
  | T_STRING dnumber dnumber orientation
    {
      if (lefData->lefrDoSite) {
        lefData->lefrSitePatternPtr = (lefiSitePattern*)lefMalloc(
                                   sizeof(lefiSitePattern));
...
trackPattern:
  K_X dnumber K_DO dnumber K_STEP dnumber 
    { 
    ...
    { lefData->lefDumbMode = 0;}
  | K_Y dnumber K_DO dnumber K_STEP dnumber
    { 
      if (lefData->lefrDoTrack) {
        lefData->lefrTrackPatternPtr = (lefiTrackPattern*)lefMalloc(
                                    sizeof(lefiTrackPattern));
...
gcellPattern: K_X dnumber K_DO dnumber K_STEP dnumber
    {
...
density_layer_rect: K_RECT pt pt dnumber ';'
    {
      if (lefCallbacks->DensityCbk)
...
timing_option:
  ...
  | K_STABLE K_SETUP dnumber K_HOLD dnumber risefall ';'
    { if (lefCallbacks->TimingCbk) lefData->lefrTiming.setStable($3,$5,$6); }
  | two_pin_trigger from_pin_trigger to_pin_trigger K_TABLEDIMENSION dnumber dnumber dnumber ';'
    { if (lefCallbacks->TimingCbk) lefData->lefrTiming.addSDF2Pins($1,$2,$3,$5,$6,$7); }
  | one_pin_trigger K_TABLEDIMENSION dnumber dnumber dnumber ';' 
...
table_entry: '(' dnumber dnumber dnumber ')'
...
list_of_table_axis_dnumbers:
  ...
  | list_of_table_axis_dnumbers dnumber
...
slew_spec:
  ...
  |  dnumber dnumber dnumber dnumber dnumber dnumber dnumber 
    { if (lefCallbacks->TimingCbk) lefData->lefrTiming.addRiseFallSlew($1,$2,$3,$4);
...
array_rule:
  ...
  | K_DEFAULTCAP dnumber cap_list K_END K_DEFAULTCAP
    {
      if (lefCallbacks->ArrayCbk) {
...
one_cap: K_MINPINS dnumber K_WIRECAP dnumber ';'
...
opt_range_second:
  ...
  | K_INFLUENCE dnumber K_RANGE dnumber dnumber
    {
      if (lefCallbacks->LayerCbk) {
        lefData->lefrLayer.setSpacingRangeInfluence($2);
...
opt_endofline:                                      // 5.7 
  // nothing 
    { }
  | K_PARALLELEDGE dnumber K_WITHIN dnumber
    {
      if (lefCallbacks->LayerCbk)
      ...
      if (lefCallbacks->LayerCbk)
{
  ...
  | K_ADJACENTCUTS dnumber K_WITHIN dnumber
    {
      if (lefCallbacks->LayerCbk) {
        if (lefData->versionNum < 5.5) {
           if (lefData->layerWarnings++ < lefSettings->LayerWarnings) {
  ...
  | K_RANGE dnumber dnumber
    ...
    opt_range_second
  | K_LENGTHTHRESHOLD dnumber
    {
      if (lefCallbacks->LayerCbk) {
        lefData->lefrLayer.setSpacingLength($2);
      }
    }
  | K_LENGTHTHRESHOLD dnumber K_RANGE dnumber dnumber
    {
      if (lefCallbacks->LayerCbk) {
        lefData->lefrLayer.setSpacingLength($2);
  ...
  | K_ENDOFLINE dnumber K_WITHIN dnumber    // 5.7 
    {
      if (lefCallbacks->LayerCbk)
  ...
  | K_ENDOFNOTCHWIDTH dnumber K_NOTCHSPACING dnumber K_NOTCHLENGTH dnumber //5.7
    {
      if (lefData->versionNum < 5.7) {
        lefData->outMsg = (char*)lefMalloc(10000);
        sprintf(lefData->outMsg,
...
universalnoisemargin: K_UNIVERSALNOISEMARGIN dnumber dnumber ';'
    {
      if (lefData->versionNum < 5.4) {
...
edgeratethreshold1: K_EDGERATETHRESHOLD1 dnumber ';'
    {
      if (lefData->versionNum < 5.4) {
...
edgeratethreshold2: K_EDGERATETHRESHOLD2 dnumber ';'
    {
      if (lefData->versionNum < 5.4) {
...
edgeratescalefactor: K_EDGERATESCALEFACTOR dnumber ';'
    {
      if (lefData->versionNum < 5.4) {
...
noisetable: K_NOISETABLE dnumber
...
correctiontable: K_CORRECTIONTABLE dnumber ';'
...
input_antenna: K_INPUTPINANTENNASIZE dnumber ';'
    { // 5.3 syntax 
        lefData->use5_3 = 1;
        if (lefData->ignoreVersion) {
           // do nothing 
...
output_antenna: K_OUTPUTPINANTENNASIZE dnumber ';'
    { // 5.3 syntax 
        lefData->use5_3 = 1;
        if (lefData->ignoreVersion) {
           // do nothing 
...
inout_antenna: K_INOUTPINANTENNASIZE dnumber ';'
    { // 5.3 syntax 
        lefData->use5_3 = 1;
        if (lefData->ignoreVersion) {
           // do nothing 
...
antenna_input: K_ANTENNAINPUTGATEAREA dnumber ';'
    { // 5.4 syntax 
...
antenna_inout: K_ANTENNAINOUTDIFFAREA dnumber ';'
    { // 5.4 syntax 
...
antenna_output: K_ANTENNAOUTPUTDIFFAREA dnumber ';'
    { // 5.4 syntax 
        // 11/12/2002 - this is obsolete in 5.5, & will be ignored 
        // 12/16/2002 - talked to Dave Noice, leave them in here for debugging
        lefData->use5_4 = 1;
