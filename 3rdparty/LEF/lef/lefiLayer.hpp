...
public:
  ...
  double lef58WidthTableOrtho(int idx) const;
  int    lef58WidthTableOrthoValues() const;
  double lef58WidthTableWrongDir(int idx) const;
  int    lef58WidthTableWrongDirValues() const;
