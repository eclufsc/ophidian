...
void static_timing_analysis::init_timing_data()
{
    ...
    m_late_sta.reset(new timing::generic_sta<timing::lumped_capacitance_wire_model, timing::pessimistic>(*m_late, *m_topology, *m_rc_trees));
    m_early_sta.reset(new timing::generic_sta<timing::lumped_capacitance_wire_model, timing::optimistic>(*m_early, *m_topology, *m_rc_trees));
...
void static_timing_analysis::update_wns_and_tns()
{
    ...
    m_ltns = timing::tns(m_endpoints, *m_late_sta).value();
    m_etns = timing::tns(m_endpoints, *m_early_sta).value();
