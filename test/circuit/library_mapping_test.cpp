...
TEST_CASE("LibraryMapping: setting the standard cell of a cell", "[library_mapping][cell]") {
    ...
    REQUIRE(libraryMapping.cellStdCell(netlistAndStdCellFixture.cell1) == netlistAndStdCellFixture.stdCell1);
    REQUIRE(libraryMapping.cellStdCell(netlistAndStdCellFixture.cell2) == netlistAndStdCellFixture.stdCell2);
    REQUIRE(libraryMapping.cellStdCell(netlistAndStdCellFixture.cell1) != libraryMapping.cellStdCell(netlistAndStdCellFixture.cell2));
}
...
TEST_CASE("LibraryMapping: setting the standard cell of a pin", "[library_mapping][pin]") {
    ...
    REQUIRE(libraryMapping.pinStdCell(netlistAndStdCellFixture.pin1) == netlistAndStdCellFixture.stdCell3);
    REQUIRE(libraryMapping.pinStdCell(netlistAndStdCellFixture.pin2) == netlistAndStdCellFixture.stdCell4);
    REQUIRE(libraryMapping.pinStdCell(netlistAndStdCellFixture.pin1) != libraryMapping.pinStdCell(netlistAndStdCellFixture.pin2));
}
