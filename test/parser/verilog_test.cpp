...
//     REQUIRE( std::count(simple.ports().begin(), simple.ports().end(), Verilog::Port(Verilog::Port::Direction::INPUT, "in")) == 1 );
//     REQUIRE( std::count(simple.ports().begin(), simple.ports().end(), Verilog::Port(Verilog::Port::Direction::OUTPUT, "out")) == 1 );
// }
//
