...
//    auto test10 = Lef{"input_files/ispd18/ispd18_test10/ispd18_test10.input.lef"};
...
//#include <ophidian/interconnection/
////TEST_CASE("HPWL", "[HPWL]")
//void hpwl()
//{
//    using namespace ophidian;
//    using netIterator = Netlist::net_container_type::const_iterator;
//    using Net = ophidian::circuit::Net;
//    using Pin = ophidian::circuit::Pin;

//    parser::Def defParser = parser::Def("sample.def");
//    parser::Lef lefParser = parser::Lef("sample.lef");
//    parser::Verilog verilogParser = parser::Verilog("sample.v");
//    design::Design design = design::factory::make_design(defParser, lefParser, verilogParser);

//    design::Design::netlist_type& netlist = design.netlist();


//    ophidian::entity_system::Property<Pin, util::LocationDbu > pinPosition( design.netlist().makeProperty<util::LocationDbu>(Pin()) );


//    for(netIterator net_it = netlist.begin_net(); net != netlist.end_net(); ++net)
//    {
//        auto net = *net_it;
//        for(auto pin : netlist.pins(net))
//        {
//            if(netlist.cell(pin) == ophidian::circuit::Cell())
//            {
//                //Pad
//                auto padInput = netlist.input(pin);
//                auto padOutput = netlist.output(pin);
//                auto location = (padInput == ophidian::circuit::Input()) ? design.placement().location(padOutput) : design.placement().location(padInput);
//                pinPosition[pin] = location;
//            }
//            else {
//                //Cell Pin
//                pinPosition[pin] = design.placement().location(pin);
//            }
//        }
//    }
