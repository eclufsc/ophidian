...
#include "../../src/interconnection_estimation/hpwl_estimation.h"

TEST_CASE("interconnection_estimation/hpwl test", "[interconnection_estimation][hpwl]") {
    ...
    openeda::interconnection_estimation::hpwl_estimation hpwl_estimation(netlist, placement);
    double hpwl = hpwl_estimation.estimate(n1);
    REQUIRE( hpwl == 730.0 );
