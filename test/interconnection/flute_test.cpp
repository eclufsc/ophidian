...
//     auto tree = flute.create(std::vector<geometry::Point<double>>{geometry::Point<double>{2.0, 2.0}, geometry::Point<double>{4.0, 4.0}});
...
// {
//     Flute & flute = Flute::instance();
//     auto tree = flute.create(std::vector<geometry::Point<double>>{geometry::Point<double>{2.0, 2.0}, geometry::Point<double>{2.0, 4.0}, geometry::Point<double>{4.0, 4.0}});
...
// {
//     Flute & flute = Flute::instance();
//     auto const tree1 = flute.create(std::vector<geometry::Point<double>>{geometry::Point<double>{-2.0, -2.0}, geometry::Point<double>{-2.0, -4.0}, geometry::Point<double>{-4.0, -4.0}, geometry::Point<double>{-13.0, -13.0}});
//     auto const tree2 = flute.create(std::vector<geometry::Point<double>>{geometry::Point<double>{2.0, 2.0}, geometry::Point<double>{2.0, 4.0}, geometry::Point<double>{4.0, 4.0}, geometry::Point<double>{13.0, 13.0}});
...
// {
//     Flute & flute = Flute::instance();
//     auto const tree = flute.create(std::vector<geometry::Point<double>>{geometry::Point<double>{0.0, 0.0}, geometry::Point<double>{50.0, 0.0}, geometry::Point<double>{15.0, -30.0}, geometry::Point<double>{43.0, 22.0}});
