...
TEST_CASE("kmeans/ run Hybrid sequential in ICCAD2015","[experiment][kmeans][Hybrid][sequential][Nrtree]") {
    for(auto circuit_name : circuits){
        ophidian::parser::DefParser reader;
        std::shared_ptr<ophidian::parser::Def> def = reader.readFile("./benchmarks/"+circuit_name+"/"+circuit_name+".def");
        ...
        ophidian::KmeansHybrid kmeansH (chipOrigin, chipBondary, (int)(flip_flop_positions.size()/50) );
        ...
        runtime->start();
        miss->start();
        kmeansH.cluster_registers(flip_flop_positions, 10);
        miss->end();
        runtime->end();
        runtime->print_result();
        miss->print_result();
...
TEST_CASE("kmeans/ run Hybrid paralel in ICCAD2015","[experiment][kmeans][Hybrid][parallel][Nrtree]") {
    for(auto circuit_name : circuits){
        ophidian::parser::DefParser reader;
        std::shared_ptr<ophidian::parser::Def> def = reader.readFile("./benchmarks/"+circuit_name+"/"+circuit_name+".def");
        ...
        runtime->start();
        miss->start();
        kmeansH.cluster_registers_parallel(flip_flop_positions, 10);
        miss->end();
        runtime->end();
        runtime->print_result();
        miss->print_result();
...
TEST_CASE("kmeans/ run Hybrid sequential with rtree in ICCAD2015","[experiment][kmeans][Hybrid][sequential][rtree]") {
    for(auto circuit_name : circuits){
        ophidian::parser::DefParser reader;
        std::shared_ptr<ophidian::parser::Def> def = reader.readFile("./benchmarks/"+circuit_name+"/"+circuit_name+".def");
        ...
        runtime->start();
        miss->start();
        kmeansH.cluster_registers_with_rtree(flip_flop_positions, 10);
        miss->end();
        runtime->end();
        runtime->print_result();
        miss->print_result();
...
TEST_CASE("kmeans/ run Hybrid paralel with rtree in ICCAD2015","[experiment][kmeans][Hybrid][parallel][rtree]") {
    for(auto circuit_name : circuits){
        ophidian::parser::DefParser reader;
        std::shared_ptr<ophidian::parser::Def> def = reader.readFile("./benchmarks/"+circuit_name+"/"+circuit_name+".def");
