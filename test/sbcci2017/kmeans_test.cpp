...
TEST_CASE("kmeans/ initialize clusters by vector","[test]") {
...
TEST_CASE("kmeans/ initialize clusters by vector parallel","[test]") {
    std::vector<ophidian::geometry::Point> flip_flop_positions = {
       {1, 1},
       {3, 2},
       {2, 1},
...
TEST_CASE("kmeans/ run DOD paralel in ICCAD2015","[kmeans][DOD][parallel]") {
    std::vector<std::string> circuits = {
        "superblue18",
//        "superblue4",
//        "superblue16",
