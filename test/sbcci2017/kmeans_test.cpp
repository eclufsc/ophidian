...
TEST_CASE("kmeans/ initialize random clusters","[test]") {
...
TEST_CASE("kmeans/ initialize clusters by vector (DOD-sequential)","[test]") {
...
TEST_CASE("kmeans/ initialize clusters by vector (DOD-parallel)","[test]") {
    std::vector<ophidian::geometry::Point> flip_flop_positions = {
       {1, 1},
       {3, 2},
       {2, 1},
...
TEST_CASE("kmeans/ initialize clusters by vector (OOD-sequential)","[test]") {
    std::vector<ophidian::geometry::Point> flip_flop_positions = {
       {1, 1},
       {3, 2},
       {2, 1},
...
TEST_CASE("kmeans/ initialize clusters by vector (OOD-parallel)","[test]") {
    std::vector<ophidian::geometry::Point> flip_flop_positions = {
       {1, 1},
       {3, 2},
       {2, 1},
...
TEST_CASE("kmeans/ run OOD parallel in ICCAD2015","[kmeans][OOD][parallel][oodparallel]") {
    std::vector<std::string> circuits = {
        "superblue18",
        "superblue4",
        "superblue16",
