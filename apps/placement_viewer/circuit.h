...
class circuit : public sf::Drawable, public sf::Transformable
{
    ...
    std::unordered_map<ophidian::entity::entity,
...
public:
    ...
    void paint_cell(ophidian::entity::entity cell, sf::Color color);


    void critical_path(const std::vector< ophidian::entity::entity > & cp);
