...
//    entity::vector_property< net_weight > net_weights;
//    tdp.net_register_property(net_weights);

//    for(std::size_t i{0}; i < 10; ++i)
//    {
//        for(auto net : tdp.nets())
//            net_weights[tdp.net_lookup(net)].value = 0.0;
...
//            net_weights[index].value = std::max(net_weights[index].value, -slack.value());
//        }
...
//                auto net_pins = tdp.net_pins(net);
