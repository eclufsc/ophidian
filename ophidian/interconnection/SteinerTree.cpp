...
namespace ophidian
{
    namespace interconnection
    {
        ...
        std::pair <SteinerTree::PointIterator,
            SteinerTree::PointIterator> SteinerTree::points() const
        {
        ...
        std::pair <SteinerTree::PointSegmentsIterator,
            SteinerTree::PointSegmentsIterator> SteinerTree::segments(
            const SteinerTree::Point & point)
        const
        {
        ...
        namespace
        {
            ...
            public:
                static void run(const SteinerTree & tree, const std::string & filename)
                {
                    ...
                    lemon::graphToEps(
                        graph,
                        filename).coords(coords).nodeColors(lemon::composeMap(palette,
                            color)).run();
                }
            };
        }     // namespace
