...
public:
    ...
    using computeStrategy_type              = computeStrategy<RowType, ColumnType, ValueType>;
    ...
    */
    ...
    {
        return computeStrategy_type::compute(rv, cv, m_C);
    }

    const row_container_type & row_values() const
    {
        return m_C.row_values;
    }

    const column_container_type & column_values() const
    {
        return m_C.column_values;
    }
