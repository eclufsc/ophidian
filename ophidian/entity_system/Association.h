 ...
 */
        ...
        public:
            ...
            public:
                ...
                PartOfComposition(
                    const EntitySystem <Part> & partSystem,
                    Association & composition):
                        EntitySystem <Part>
                        ::NotifierType::ObserverBase(*partSystem.notifier()),
        ...
        public:
            ...
            public:
                ...
                class PartIterator :
                    public std::iterator <std::forward_iterator_tag, Part>
                {
                public:
